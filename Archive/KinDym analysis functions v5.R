### Changes since v4
# addition of splitting sex when plotting m vs f relatedness to allow differing lifespan lengths(lines 190-200)
# addition of delta r, individual level delta r and a wrapper for the relatedness gam functions
# run_delta_r_tests to calcuate delta r and run the modle
